...
namespace RE.Pessoas.API.Data
{
    public class PessoaContext : DbContext, IUnitOfWork
    {
        private readonly IMediatorHandler _mediatorHandler;
        public PessoaContext(DbContextOptions<PessoaContext> options, IMediatorHandler mediatorHandler)
            : base(options)
        {
